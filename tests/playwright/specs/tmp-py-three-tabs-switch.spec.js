...
test('py3ファイルを開いてタブ切替できる', async ({ page }) => {
  ...
  await page.locator('.workspace-tab .workspace-tab__title', { hasText: '__tab_test_a' }).first().click();
  await expect(editor).toHaveValue("print('A')\n");
